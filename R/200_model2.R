...
i5s9l4_ln <- simulate_intconsis_likertnorm(5, .9, .4)
i5s9l3_ln <- simulate_intconsis_likertnorm(5, .9, .3)
...
i10s9l4_ln <- simulate_intconsis_likertnorm(10, .9, .4)
i10s9l3_ln <- simulate_intconsis_likertnorm(10, .9, .3)
...
i15s9l4_ln <- simulate_intconsis_likertnorm(15, .9, .4)
i15s9l3_ln <- simulate_intconsis_likertnorm(15, .9, .3)
...
i20s9l4_ln <- simulate_intconsis_likertnorm(20, .9, .4)
i20s9l3_ln <- simulate_intconsis_likertnorm(20, .9, .3)
...
i25s9l4_ln <- simulate_intconsis_likertnorm(25, .9, .4)
i25s9l3_ln <- simulate_intconsis_likertnorm(25, .9, .3)
